...
class FLRepoTest(unittest.TestCase):
    ...
    def test_uploadTM(self):
        ...
        self.assertIn("Upload TM", self.browser.find_element_by_tag_name("h1").text)
        ...
        self.browser.switchTo().activeElement().sendKeys('c:\Sites\flrepo\FLRepo\media\CON-CC_Working_en2es-mx_201412450_SW.tmx')
